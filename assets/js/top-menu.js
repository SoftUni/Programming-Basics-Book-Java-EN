gitbook.events.bind("page.change", function() {
    ...
    let topMenu = $(`
        <p class="topnav">
            <a class="logobox" target="_blank" href="https://softuni.org/learn?utm_source=FreeProgrammingBooks&utm_medium=logo&utm_campaign=JavaBook"><img class="logo" src="/assets/softuni-global-logo.svg" alt="logo"></a>
